 ...
 * @author (ozhytary)
 */
@Mapper(config = MapperConfiguration.class, uses = {QuestionMapper.class, CategoryMapper.class})
public interface QuizMapper extends LazyInitMapper {
    ...
    @Condition
    @Override
    default <Question> boolean isNotLazyInit(Collection<Question> collection) {
